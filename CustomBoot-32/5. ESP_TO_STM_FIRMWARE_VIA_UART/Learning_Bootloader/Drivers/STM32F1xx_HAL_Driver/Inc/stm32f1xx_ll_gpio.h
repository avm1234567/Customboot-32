...
/**
  * @brief Enable the remapping of USART1 alternate function CTS, RTS, CK, TX and RX.
  * @rmtoll MAPR          USART1_REMAP           LL_GPIO_AF_EnableRemap_USART1
...
/**
  * @brief Disable the remapping of USART1 alternate function CTS, RTS, CK, TX and RX.
  * @rmtoll MAPR          USART1_REMAP           LL_GPIO_AF_DisableRemap_USART1
