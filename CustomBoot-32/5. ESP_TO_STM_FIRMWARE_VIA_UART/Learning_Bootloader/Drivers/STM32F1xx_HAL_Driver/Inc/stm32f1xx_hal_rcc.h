...
#define __HAL_RCC_USART1_CLK_ENABLE()   do { \
                                        __IO uint32_t tmpreg; \
                                        SET_BIT(RCC->APB1ENR, RCC_APB1ENR_USART1EN);\
                                        /* Delay after an RCC peripheral clock enabling */\
                                        tmpreg = READ_BIT(RCC->APB1ENR, RCC_APB1ENR_USART1EN);\
                                        UNUSED(tmpreg); \
                                      } while(0U)
...
#define __HAL_RCC_USART1_CLK_DISABLE()    (RCC->APB1ENR &= ~(RCC_APB1ENR_USART1EN))
...
#define __HAL_RCC_USART1_IS_CLK_ENABLED()     ((RCC->APB1ENR & (RCC_APB1ENR_USART1EN)) != RESET)
#define __HAL_RCC_USART1_IS_CLK_DISABLED()    ((RCC->APB1ENR & (RCC_APB1ENR_USART1EN)) == RESET)
...
#define __HAL_RCC_USART1_FORCE_RESET()     (RCC->APB1RSTR |= (RCC_APB1RSTR_USART1RST))
...
#define __HAL_RCC_USART1_RELEASE_RESET()     (RCC->APB1RSTR &= ~(RCC_APB1RSTR_USART1RST))
